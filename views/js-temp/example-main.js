...
var selectRandomMeat = function() {
    ...
    pizzaElementGenerator = function(e) {
        var a, r, n, i, t, o;
        return a = document.createElement("div"), r = document.createElement("div"), n = document.createElement("img"), i = document.createElement("div"), a.classList.add("randomPizzaContainer"), a.style.width = "33.33%", a.style.height = "325px", a.id = "pizza" + e, r.style.width = "35%", n.src = "images/pizza.webp", n.classList.add("img-responsive"), n.alt = "A delicious pizza", r.appendChild(n), a.appendChild(r), i.style.width = "65%", (t = document.createElement("h3")).innerHTML = randomName(), i.appendChild(t), (o = document.createElement("ul")).innerHTML = makeRandomPizza(), i.appendChild(o), a.appendChild(i), a
    },
...
function updatePositions() {
    isUpdating || (isUpdating = !0, window.requestAnimationFrame((function() {
        frame++, window.performance.mark("mark_start_frame");
        for (var e = document.querySelectorAll(".mover"), a = document.documentElement.scrollTop || document.body.scrollTop, r = 0; r < e.length; r++) {
...
var aspectRatio = 232 / 300;
document.addEventListener("DOMContentLoaded", (function() {
    for (var e = 0; e < 200; e++) {
        var a = document.createElement("img");
        a.className = "mover", a.src = "images/pizza.webp", a.style.height = "100px", a.style.width = 100 * aspectRatio + "px", a.basicLeft = e % 8 * 256, a.style.top = 256 * Math.floor(e / 8) + "px", a.alt = "A moving pizza image", document.querySelector("#movingPizzas1").appendChild(a)
    }
    updatePositions()
}));